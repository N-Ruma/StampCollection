# 変更履歴
2025/12/20:
- `develop`，`develop__*`ブランチのPRにおけるレビュー条件を削除しました.

2025/11/30:
- PILによる画像加工の参考文献を追加しました． -> [PIL画像加工チートシート](#image_edit)
...
# 参考文献
- <a href="https://qiita.com/pashango2/items/145d858eff3c505c100a" id="image_edit">PIL画像加工チートシート</a>
